...
use Procountor\Interfaces\Read\Attachment as AttachmentRead;
...
class LedgerReceipt implements LedgerReceiptRead {
    private $data;
    ...
    {
        return $this->data->vatProcessing;
    }
    ...
    {
        return $this->data->accountantsNotes;
    }
